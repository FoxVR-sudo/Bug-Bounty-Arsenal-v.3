...
const MobileUploadPanel = () => {
  ...
  return (
    <div className="ui-card p-4 lg:p-6 mt-6">
      {/* Section header */}
      <div className="flex items-center gap-2 mb-4">
        <FiSmartphone className="text-indigo-500 text-xl flex-shrink-0" />
        <div>
          <h3 className="text-base lg:text-lg font-semibold text-gray-900 dark:text-white">
            APK / IPA Static Analysis
          </h3>
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Upload an Android <strong>.apk</strong> or iOS <strong>.ipa</strong> for static
            security analysis — no external tools required.
          </p>
        </div>
      </div>
      ...
      {!isScanning && (
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            ...
            {file ? (
              ...
              <>
                ...
                <p className="text-xs text-gray-400 mt-1">.apk or .ipa · max {MAX_FILE_MB} MB</p>
              </>
            )}
          </div>
          ...
          <button
            ...
            className="ui-btn ui-btn-primary w-full justify-center disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            <FiSmartphone />
            Start APK / IPA Scan
          </button>
...
export default MobileUploadPanel;
